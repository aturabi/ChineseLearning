...
public class LearnChinese extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        if(args.length != 3){
            System.out.println("Please make sure you are using the correct format: java LearnChinese fileName numTranslationsInFile numToDisplay");
            System.out.println("For example:");
            System.out.println("java Main chinesewords.txt 10 2");
            System.out.println("This means there are 10 translations in the file 'chinesewords.txt' and I want to display 2");
            return;
        }
    ...
    public static void addText(){
        ...
        try{
            ...
            System.out.println("Error: the file " + filename + " does not exist in the same folder as this program");
            System.out.println("Please check the file name or move the file into this program's folder");
            System.exit(0);
        }
    }
}
